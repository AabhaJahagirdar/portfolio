export const projectsData = [
    ...
    {
          id: 2,
          name: 'NeuroCare: Alzheimer’s Classification',
          description: 'An AI-powered diagnostic tool that utilizes Convolutional Neural Networks (CNN) to classify Alzheimer’s disease stages from MRI scans with high accuracy.',
          tools: ['Python', 'TensorFlow', 'Keras', 'OpenCV', 'CNN', 'NumPy'],
          role: 'AI & ML Developer',
          code: 'https://github.com/AabhaJahagirdar/NeuroCare',
          demo: '',
    },
    // {
    //     id: 2,
    ...
    // },
     {
        ...
        tools: ['Next.js','React','Tailwind CSS','Framer Motion','Lottie','JavaScript','HTML','CSS','Netlify'],
        code: 'https://github.com/AabhaJahagirdar/portfolio/',
        demo: 'https://aabhajahagirdar.netlify.app/',
    ...
    },
    {
      ...
      tools: ['Rust','Natural Language Processing','Tokenization','Sentiment Analysis','Cargo','Serde','Regex','Machine Learning Concepts' ],
      code: '',
      demo: '', 
